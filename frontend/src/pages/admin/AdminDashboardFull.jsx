...
export default function AdminDashboard({ onAdminLogout }) {
  ...
  // View states
  const [activeTab, setActiveTab] = useState('students'); // 'students', 'marks', 'attendance', 'fees'
  ...
  const handleBulkMarksEntry = async () => {
    try {
      ...
      const data = await response.json();
      if (data.success) {
        showToast(`Marks saved for ${data.saved} students!`);
        setMarksForm({ section: '', subject: '', testType: 'M1', marks: [] });
      } else {
  ...
  const handleAttendanceUpdate = async () => {
    try {
      const response = await fetch(`http://localhost:5000/api/admin/student/${attendanceForm.regdNo}/attendance`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${adminToken}`,
          'Content-Type': 'application/json'
      ...
      if (data.success) {
        ...
        setAttendanceForm({ regdNo: '', subject: '', semester: '', attendedClasses: '', totalClasses: '' });
        fetchAllStudents();
      } else {
  ...
  // Students Tab
  if (activeTab === 'students' && viewMode === 'list') {
    return (
  ...
  // Edit Student View
  if (activeTab === 'students' && viewMode === 'edit') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
        {/* Header */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-xl font-bold text-slate-900">Bulk Marks Entry</h1>
                  <p className="text-xs text-slate-500">Enter marks for multiple students</p>
                </div>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setMarksForm(prev => ({ ...prev, section: e.target.value }))}
                  placeholder="e.g., A, B, C"
              ...
              <div>
                ...
                <select
                  value={marksForm.testType}
                  onChange={(e) => setMarksForm(prev => ({ ...prev, testType: e.target.value }))}
                  className="w-full px-3 py-2 border border-slate-200 rounded-lg"
                >
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
              <p className="text-sm text-amber-800">
                ...
                This will update the student portal in real-time.
              </p>
            </div>
          </div>
        </main>
            ...
            <div className="flex items-center justify-between h-16">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">Update student attendance</p>
                </div>
              </div>
        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-1">Student Regd No *</label>
                <input
                  type="text"
                  value={attendanceForm.regdNo}
                  onChange={(e) => setAttendanceForm(prev => ({ ...prev, regdNo: e.target.value }))}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setAttendanceForm(prev => ({ ...prev, attendedClasses: e.target.value }))}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setAttendanceForm(prev => ({ ...prev, totalClasses: e.target.value }))}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setAttendanceForm(prev => ({ ...prev, semester: e.target.value }))}
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-6">
              <p className="text-sm text-blue-800">
                <strong>Real-time Update:</strong> Attendance changes will be immediately reflected in the student portal.
              </p>
            </div>
          </div>
        </main>
  ...
  // Fees Tab (placeholder - can be expanded)
  if (activeTab === 'fees') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
        {/* Header */}
            ...
            <div className="flex items-center justify-between h-16">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">Manage student fees and payments</p>
                </div>
              </div>
        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2">Fee Management</h3>
              <p className="text-slate-600 mb-4">
                Fee management is integrated into the student profile editing. 
                Go to the Students tab to edit student fee information.
              </p>
              <button
                onClick={() => setActiveTab('students')}
